...
exports.InitialSchema11750722432165 = void 0;
class InitialSchema11750722432165 {
    constructor() {
        this.name = 'InitialSchema11750722432165';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "atividades" ("id" SERIAL NOT NULL, "titulo" character varying NOT NULL, "descricao" text NOT NULL, "horasSolicitadas" integer NOT NULL, "dataInicio" date NOT NULL, "dataFim" date, "status" "public"."atividades_status_enum" NOT NULL DEFAULT 'Pendente', "dataSubmissao" TIMESTAMP NOT NULL DEFAULT now(), "documentoComprovanteUrl" character varying, "observacoesAluno" text, "aluno_id" integer, "categoria_id" integer, CONSTRAINT "PK_a6aaafbd59aa3ed64c5fa2b196b" PRIMARY KEY ("id"))`);
...
exports.InitialSchema11750722432165 = InitialSchema11750722432165;
