...
export class Migrations1753550352935 implements MigrationInterface {
    name = 'Migrations1753550352935'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "alunos" ("id" SERIAL NOT NULL, "nome" character varying(100) NOT NULL, "email" character varying(100) NOT NULL, "senha" character varying(20) NOT NULL, "matricula" character varying(20) NOT NULL, "curso" character varying(25) NOT NULL, CONSTRAINT "UQ_1f9a8f3f4e5a314a2d7f828a605" UNIQUE ("email"), CONSTRAINT "UQ_6e0968af8b901a2773bf17aa366" UNIQUE ("matricula"), CONSTRAINT "UQ_f012d93a70d38af087147449698" UNIQUE ("curso"), CONSTRAINT "PK_0090f2d8573e71e8e4e274db905" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "funcionarios" ("id" SERIAL NOT NULL, "nome" character varying(100) NOT NULL, "email" character varying(100) NOT NULL, "senha" character varying(20) NOT NULL, "cargo" character varying(25) NOT NULL, CONSTRAINT "UQ_5536df94d421db7d1a1ba832f0f" UNIQUE ("email"), CONSTRAINT "PK_a6ee7c0e30d968db531ad073337" PRIMARY KEY ("id"))`);
